...
class TeamStatsRowFilterTests(unittest.TestCase):
    def test_keeps_zero_rows_for_active_teams(self) -> None:
        self.assertTrue(_team_stats_row_has_data({"team": "CBJ", "gp": 0, "pts": 0}))
        self.assertTrue(_team_stats_row_has_data({"team": "CGY", "gp": "0"}))
        self.assertFalse(_team_stats_row_has_data({"gp": 0}))
